...
with open('2015.csv', 'r') as f_diarias_2015:
    csvReader = csv.reader(f_diarias_2015, delimiter=',')
    ...
    print('Valor Minimo: R$' + str(dataByValue[0]['value']) + ' ( ' + dataByValue[0]['person'] + ' ) ')
    print('Valor Maximo: R$' + str(dataByValue[len(dataByValue) - 1]['value']) + ' ( ' + dataByValue[len(dataByValue) - 1]['person'] + ' ) ' )
    print 'Amplitude: ', str((dataByValue[len(dataByValue) - 1]['value']) - (dataByValue[0]['value'] / 100))
